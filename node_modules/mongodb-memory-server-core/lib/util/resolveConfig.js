...
const log = debug_1.default('MongoMS:ResolveConfig');
...
function findPackageJson(directory) {
    var _a, _b, _c;
    let filename;
    for (const found of find_package_json_1.default(directory || process.cwd())) {
        ...
        filename = found.__path;
        log(`findPackageJson: Found package.json at "${filename}"`);
        if (Object.keys((_b = (_a = found === null || found === void 0 ? void 0 : found.config) === null || _a === void 0 ? void 0 : _a.mongodbMemoryServer) !== null && _b !== void 0 ? _b : {}).length > 0) {
            ...
            packageJsonConfig = (_c = found === null || found === void 0 ? void 0 : found.config) === null || _c === void 0 ? void 0 : _c.mongodbMemoryServer;
            break;
        }
    }
    ...
    if (filename) {
        ...
        // "cc*" means "camelcase"
        const ccDownloadDir = camelcase_1.default(ResolveConfigVariables.DOWNLOAD_DIR);
        const ccSystemBinary = camelcase_1.default(ResolveConfigVariables.SYSTEM_BINARY);
...
function resolveConfig(variableName) {
    var _a, _b, _c;
    return (_c = ((_b = (_a = process.env[envName(variableName)]) !== null && _a !== void 0 ? _a : packageJsonConfig[camelcase_1.default(variableName)]) !== null && _b !== void 0 ? _b : exports.defaultValues.get(variableName))) === null || _c === void 0 ? void 0 : _c.toString();
}
